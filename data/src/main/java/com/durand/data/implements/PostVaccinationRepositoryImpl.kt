...
import com.durand.data.mapper.vaccination.VaccinationRequestMapper
...
class PostVaccinationRepositoryImpl:PostVaccinationRepository {
    val gson = Gson()
    override suspend fun getVaccination(product: VaccinationRequest): ResultType<Failure, VaccinationResponseModel> {
        val body: VaccinationRequestEntities = VaccinationRequestMapper.transformRequest(product)
        ...
        return try {
            ...
            return if (result.isSuccessful) {
                ...
                val datoEntity: VaccinationResponseEntities = gson.fromJson(gson.toJson(result.body), VaccinationResponseEntities::class.java)
