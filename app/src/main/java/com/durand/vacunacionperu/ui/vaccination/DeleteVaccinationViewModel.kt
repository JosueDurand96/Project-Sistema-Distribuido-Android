...
import com.durand.domain.usecases.DeleteVaccinationUseCase
...
class DeleteVaccinationViewModel : ViewModel(), KoinComponent {

    private val putVaccinationUseCase: DeleteVaccinationUseCase by inject()
    ...
    fun postVaccination(vaccinationRequest: String) {
        try {
